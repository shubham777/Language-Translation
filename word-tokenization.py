...
class VanillaRnn(object):
    def __init__(self, source_dimension, target_dimension, hidden_dimension, bptt_truncate=5):
        ...
        self.We = np.random.uniform(-np.sqrt(1. / source_dimension), np.sqrt(1. / source_dimension),
                                    (hidden_dimension, source_dimension))
        self.Ue = np.random.uniform(-np.sqrt(1. / hidden_dimension), np.sqrt(1. / hidden_dimension),
                                    (hidden_dimension, hidden_dimension))
        self.Wd = np.random.uniform(-np.sqrt(1. / target_dimension), np.sqrt(1. / target_dimension),
                                    (hidden_dimension, target_dimension))
        self.Ud = np.random.uniform(-np.sqrt(1. / hidden_dimension), np.sqrt(1. / hidden_dimension),
                                    (hidden_dimension, hidden_dimension))
        self.V = np.random.uniform(-np.sqrt(1. / hidden_dimension), np.sqrt(1. / hidden_dimension),
                                   (hidden_dimension, hidden_dimension))
        self.P = np.random.uniform(-np.sqrt(1. / hidden_dimension), np.sqrt(1. / hidden_dimension),
                                   (target_dimension, hidden_dimension))
